...
use crate::utils::{UpdateStatus, VecBuf, path_as_crate_mod, slice_groups, update_text_region_fn};
...
impl ParsedLints<'_> {
    ...
    pub fn gen_decls(&self, updater: &mut FileUpdater<'_>) {
        ...
        updater.update_loaded_file(self.deprecated_file, &mut |_, src, dst| {
        ...
        updater.update_file("tests/ui/deprecated.rs", &mut |_, src, dst| {
        ...
        updater.update_file("tests/ui/rename.rs", &mut move |_, src, dst| {
        ...
        for lints in slice_groups(&active, |(_, (head, _)), tail| {
            ...
            updater.update_file(Path::new(krate).join("src/declared_lints.rs"), &mut |_, src, dst| {
                dst.push_str(GENERATED_FILE_COMMENT);
        ...
        updater.update_file("src/register_passes.rs", &mut |_, src, dst| {
