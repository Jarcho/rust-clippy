...
use rustc_hir::{
    ...
    ItemKind, LangItem, LetStmt, MatchSource, Mutability, Node, OwnerId, OwnerNode, Param, Pat, PatKind, Path,
...
pub fn in_automatically_derived(tcx: TyCtxt<'_>, node: HirId) -> bool {
    tcx.hir()
        .parent_owner_iter(node)
