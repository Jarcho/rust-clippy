...
use overflow_check_conditional::OverflowCheckConditional;
...
use set_contains_or_insert::HashsetInsertAfterContains;
use shadow::Shadow;
...
rustc_lint::late_lint_methods!(
    ...
    [
        ...
        [
            ...
            HashsetInsertAfterContains: HashsetInsertAfterContains,
